 ...
 *
 */
public class Pro0580 {
	//(select dept_name, student_number from (select dept_name, count(student_id) as student_number  from department d left join student s on d.dept_id = s.dept_id  group by d.dept_name )as t order by student_number DESC, dept_name );
}
