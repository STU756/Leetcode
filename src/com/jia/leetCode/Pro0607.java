 ...
 *
 */
public class Pro0607 {
/**
 * select salesperson.name from salesperson where sales_id not in (select orders.sales_id from orders,company where orders.com_id  = company.com_id and company.name = 'RED');
 */
}
