 ...
 *
 */
public class Pro0800 {
    public String similarRGB(String color) {
        return "#" + help(color.substring(1, 3)) + help(color.substring(3, 5)) + help(color.substring(5, 7)); 
    }

	private String help(String substring) {
		int q = Integer.parseInt(substring,16);
		q = q / 17 + ((q % 17 > 8)? 1 : 0);
